...
We have also classified our patients as either "on" or "off" each medication, by changing the values 'Down, Up, Steady' to True and values 'No' to False. Moreover, we created new variable columns for each drug class family and indicated whether a patient takes any medication within each family of drugs.
